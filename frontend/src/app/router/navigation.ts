...
export const NAV_ITEMS: readonly NavItem[] = [
  ...
  { name: 'work-orders-mine', title: '我的工单', group: '校园服务', permissions: ['work_order:read'] },
  { name: 'work-orders-handle', title: '工单处理', group: '校园服务', permissions: ['work_order:transition'] },
  { name: 'electricity', title: '电费查询', group: '校园服务', permissions: ['electricity:read_own'] },
  { name: 'chat', title: '知识问答', group: '知识库', permissions: ['chat:use'] },
  { name: 'knowledge-bases', title: '知识库管理', group: '知识库', permissions: ['knowledge:read'] },
  { name: 'knowledge-ingestion', title: '文档入库', group: '知识库', permissions: ['knowledge:publish'] },
  ...
  { name: 'agent-runs', title: 'Agent 工作台', group: 'Agent', permissions: ['agent:run'] },
  { name: 'agent-catalog', title: 'Agent 目录', group: 'Agent', permissions: ['agent:catalog:read'] },
  { name: 'tool-catalog', title: 'Tool 目录', group: 'Agent', permissions: ['tool:catalog:read'] },
