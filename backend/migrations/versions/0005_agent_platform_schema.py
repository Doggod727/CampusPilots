"""Create the M5 agent platform schema.

Revision ID: 0005_agent_platform_schema
Revises: 0004_platform_m5_compat
"""
...
revision: str = "0005_agent_platform_schema"
down_revision: str | None = "0004_platform_m5_compat"
...
DOWNGRADE_STATEMENTS = (
    "DROP TABLE agent_platform.agent_handoffs",
    "DROP TABLE agent_platform.approval_requests",
    "DROP TABLE agent_platform.tool_calls",
    "DROP TABLE agent_platform.agent_steps",
    "DROP TABLE agent_platform.agent_runs",
    "DROP TABLE agent_platform.evaluation_metrics",
    "DROP TABLE agent_platform.evaluation_jobs",
    "DROP TABLE agent_platform.model_versions",
    "DROP TABLE agent_platform.training_jobs",
    "DROP TABLE agent_platform.dataset_versions",
    "DROP TABLE agent_platform.datasets",
    "DROP TABLE agent_platform.tool_versions",
    "DROP TABLE agent_platform.tool_definitions",
    "DROP TABLE agent_platform.agent_versions",
    "DROP TABLE agent_platform.agent_definitions",
    "DROP FUNCTION agent_platform.set_updated_at()",
    "DROP SCHEMA agent_platform",
)


def _split_sql(script: str) -> Iterator[str]:
    """Split trusted migration SQL without breaking quoted function bodies."""
    statement_start = 0
    index = 0
