"""Create the M2 campus service schema.

Revision ID: 0002_campus_service_schema
...
revision: str = "0002_campus_service_schema"
...
DOWNGRADE_STATEMENTS = (
    "DROP TABLE campus_service.work_order_ratings",
    "DROP TABLE campus_service.work_order_events",
    "DROP TABLE campus_service.work_orders",
    "DROP TABLE campus_service.guide_steps",
    "DROP TABLE campus_service.guide_materials",
    "DROP TABLE campus_service.guide_applicabilities",
    "DROP TABLE campus_service.service_guides",
    "DROP TABLE campus_service.guide_categories",
    "DROP TABLE campus_service.department_contacts",
    "DROP TABLE campus_service.departments",
    "DROP TABLE campus_service.campuses",
    "DROP FUNCTION campus_service.set_updated_at()",
    "DROP SCHEMA campus_service",
)
