...
DOWNGRADE_STATEMENTS = (
    ...
    "DROP TABLE platform.app_configs",
    "DROP TABLE platform.audit_logs",
    "DROP TABLE platform.moderation_cases",
    "DROP TABLE platform.sensitive_words",
    "DROP TABLE platform.refresh_tokens",
    ...
    "DROP FUNCTION platform.set_updated_at()",
