"""Create the M3 community schema.

Revision ID: 0007_community_schema
...
revision: str = "0007_community_schema"
down_revision: str | None = "0006_agent_runtime_delivery"
...
DOWNGRADE_STATEMENTS = (
    "DROP TABLE community.lost_found_claims",
    "DROP TABLE community.lost_found_matches",
    "DROP TABLE community.lost_found_items",
    "DROP TABLE community.event_registrations",
    "DROP TABLE community.campus_events",
    "DROP TABLE community.content_reports",
    "DROP TABLE community.post_reactions",
    "DROP TABLE community.comments",
    "DROP TABLE community.posts",
    "DROP TABLE community.topics",
    "DROP FUNCTION community.set_updated_at()",
